...
// ---------------------------
// Interfaces ERC20 y ERC20Permit
// ---------------------------
interface IERC20 {
...
// ---------------------------
// Contrato Gainovo Trading
// ---------------------------
/**
 * @title Gainovo Trading
 * @notice Token ERC20 con sistema multi‑firma, listas blanca/negra, pausabilidad por rol de emergencia y EIP‑2612.
 * Se mintean inicialmente todos los tokens (máximo supply) y el minteo posterior solo es posible si se han quemado tokens.
 */
contract GainovoTrading is IERC20, IERC20Permit {
    using ECDSA for bytes32;

    string public constant name = "Gainovo Trading";
    string public constant symbol = "GNT";
    uint8 public constant decimals = 18;
    
    // Máximo de tokens: 5.000.000 (con 18 decimales)
    uint256 public constant MAX_SUPPLY = 5000000 * (10 ** decimals);
    ...
    constructor(address[] memory propietariosIniciales) {
        ...
        // Se mintean todos los tokens disponibles (MAX_SUPPLY) al primer propietario
    ...
    function _crearPropuesta(
        ...
        require(destino != address(0) || (tipo != TipoOperacion.Mintear && 
               tipo != TipoOperacion.Quemar && 
               tipo != TipoOperacion.AgregarGestor && 
               tipo != TipoOperacion.RemoverGestor && 
               tipo != TipoOperacion.AgregarPropietario && 
               tipo != TipoOperacion.RemoverPropietario && 
               tipo != TipoOperacion.AgregarEmergencia && 
               tipo != TipoOperacion.RemoverEmergencia), "Direccion invalida");
        conteoPropuestas++;
    ...
    // Las funciones públicas para crear propuestas permanecen igual:
    ...
    /**
     * @notice Registra el voto de una propuesta pendiente.
     * Esta función solo registra el voto; la ejecución se realizará de forma separada.
     ...
     * Puede ser llamada por cualquier propietario.
     * @param idPropuesta Identificador de la propuesta.
     */
     ...
     * @param idPropuesta Identificador de la propuesta.
     * @return true si las aprobaciones alcanzan el umbral.
     */
    ...
    // Gestión de listas (solo gestores)
